                ...
                <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    <div className="max-w-md mx-auto relative">
                        ...
                        <input
                            ...
                            className="block w-full pl-10 pr-3 py-3 border border-slate-700 rounded-xl leading-5 bg-slate-800/50 text-slate-300 placeholder-slate-500 focus:outline-none focus:bg-slate-800 focus:border-blue-500 transition-colors sm:text-sm"
